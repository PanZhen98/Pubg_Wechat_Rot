...
SYSTEM_MSG = (
    ...
    "- 回答简洁自然，使用粤语，保持 PUBG 游戏风格，可以适当幽默。\n"
...
_EVAL_TIERS = {
    "daily": (
        "夯（KD≥1.8）：纯嘲讽无傲娇，暗示KD高是靠K头（爆头）刷出来的不是真实力，毒舌攻击性最强\n"
        "顶级（KD 1.3~1.8）：强烈嘲讽，暗示KD是靠K头堆的，不是真强，讽刺意味重\n"
        "人上人（KD 1.1~1.3）：轻度嘲讽，隐约暗示运气成分多\n"
        "npc（KD 0.5~1.1）：鼓励性语气，温柔安慰，加油打气\n"
        "拉完了（KD<0.5）：鼓励性语气，温柔安慰，加油打气"
    ),
    "season": (
        "夯（KD≥1.6）：纯嘲讽无傲娇，暗示KD高是靠K头（爆头）刷出来的不是真实力，毒舌攻击性最强\n"
        "顶级（KD 1.3~1.6）：强烈嘲讽，暗示KD是靠K头堆的，不是真强，讽刺意味重\n"
        "人上人（KD 1.1~1.3）：轻度嘲讽，隐约暗示运气成分多\n"
        "npc（KD 0.3~1.1）：鼓励性语气，温柔安慰，加油打气\n"
        "拉完了（KD<0.3）：鼓励性语气，温柔安慰，加油打气"
    ),
    "lifetime": (
        "夯（KD≥1.4）：纯嘲讽无傲娇，暗示KD高是靠K头（爆头）刷出来的不是真实力，毒舌攻击性最强\n"
        "顶级（KD 1.2~1.4）：强烈嘲讽，暗示KD是靠K头堆的，不是真强，讽刺意味重\n"
        "人上人（KD 1.0~1.2）：轻度嘲讽，隐约暗示运气成分多\n"
        "npc（KD 0.1~1.0）：鼓励性语气，温柔安慰，加油打气\n"
        "拉完了（KD<0.1）：鼓励性语气，温柔安慰，加油打气"
    ),
}
...
_HELP_MSG = (
    ...
    "评价战绩：评价 6umm / 评价 6umm 昨日 / 评价 6umm 赛季 / 评价 6umm 生涯\n"
    "登记ID参与每日称号：登记 6umm\n"
    "\n"
