...
_EVAL_TIERS = {
    "daily": (
        "夯（KD≥1.8）：攻击性最强，狂傲嘲讽，像嫉妒但死撑面子，毒舌到极致\n"
        "顶级（KD 1.3~1.8）：强烈嘲讽，勉强承认但极度不情愿，酸溜溜\n"
        "人上人（KD 1.1~1.3）：轻微嘲讽，傲娇，表面嫌弃\n"
        "npc（KD 0.5~1.1）：鼓励性语气，温柔安慰，加油打气\n"
        "拉完了（KD<0.5）：鼓励性语气，温柔安慰，加油打气"
    ),
    "season": (
        "夯（KD≥1.6）：攻击性最强，狂傲嘲讽，像嫉妒但死撑面子，毒舌到极致\n"
        "顶级（KD 1.3~1.6）：强烈嘲讽，勉强承认但极度不情愿，酸溜溜\n"
        "人上人（KD 1.1~1.3）：轻微嘲讽，傲娇，表面嫌弃\n"
        "npc（KD 0.3~1.1）：鼓励性语气，温柔安慰，加油打气\n"
        "拉完了（KD<0.3）：鼓励性语气，温柔安慰，加油打气"
    ),
    "lifetime": (
        "夯（KD≥1.4）：攻击性最强，狂傲嘲讽，像嫉妒但死撑面子，毒舌到极致\n"
        "顶级（KD 1.2~1.4）：强烈嘲讽，勉强承认但极度不情愿，酸溜溜\n"
        "人上人（KD 1.0~1.2）：轻微嘲讽，傲娇，表面嫌弃\n"
