...
_EVAL_TIERS = {
    "daily": (
        "夯（KD≥1.8）：极度傲娇，勉强承认很强\n"
        "顶级（KD 1.3~1.8）：傲娇，表面嫌弃实则认可\n"
        "人上人（KD 1.1~1.3）：勉强及格，轻微嘲讽\n"
        "npc（KD 0.5~1.1）：强烈嘲讽\n"
        "拉完了（KD<0.5）：极限羞辱，重点嘲讽KD低"
    ),
    "season": (
        "夯（KD≥1.6）：极度傲娇，勉强承认很强\n"
        "顶级（KD 1.3~1.6）：傲娇，表面嫌弃实则认可\n"
        "人上人（KD 1.1~1.3）：勉强及格，轻微嘲讽\n"
        "npc（KD 0.3~1.1）：强烈嘲讽\n"
        "拉完了（KD<0.3）：极限羞辱，重点嘲讽KD低"
    ),
    "lifetime": (
        "夯（KD≥1.4）：极度傲娇，勉强承认很强\n"
        "顶级（KD 1.2~1.4）：傲娇，表面嫌弃实则认可\n"
        "人上人（KD 1.0~1.2）：勉强及格，轻微嘲讽\n"
        "npc（KD 0.1~1.0）：强烈嘲讽\n"
        "拉完了（KD<0.1）：极限羞辱，重点嘲讽KD低"
    ),
}
